...
read_chunk( path=file.path( WORKING_DIR, "01_prepareReferenceData.R"));
read_chunk( path=file.path( WORKING_DIR, "02_prepareRNAseqData.R"));
```
...
```{r load_reference_data}
  <<loadReferenceData>>
```
<br /><br />

### Load data from RNA-seq experiment
```{r load_rnaseq_data}
<<loadRNAseqData>>
```
<br /><br />
