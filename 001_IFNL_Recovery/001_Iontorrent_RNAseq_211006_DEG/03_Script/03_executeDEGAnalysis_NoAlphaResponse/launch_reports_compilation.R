...
REFERENCE_CONDITION = "WT_NT"
TEST_CONDITION = "KO_NT"

rmarkdown::render( input = file.path( WORKING_DIR, "Report.Rmd"),
                   output_dir = PATH_ANALYSIS_OUTPUT,
                   output_file  = paste0( PROJECT_SHORT_NAME, "_", EXPERIMENT_NAME, "_", ANALYSIS_STEP_NAME, "_",
                                          TEST_CONDITION, "_vs_", REFERENCE_CONDITION, ".html"),
                   quiet = FALSE)  

REFERENCE_CONDITION = "WT_IFN"
TEST_CONDITION = "KO_IFN"
