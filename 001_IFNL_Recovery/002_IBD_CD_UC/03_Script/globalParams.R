...
PROJECT_NAME = "ABlab - IFNL Recovery - Data of Crhon Disease (CD) and Ulcerative Colitis (UC) from PNlab";
PROJECT_SHORT_NAME = "001_IFNL_Recovery"

PATH_PROJECT = "/mnt/DOSI/ABLAB/BIOINFO/Project/IFNLGutRestitution/001_IFNL_Recovery"

EXPERIMENT_NAME = "002_IBD_CD_UC"
