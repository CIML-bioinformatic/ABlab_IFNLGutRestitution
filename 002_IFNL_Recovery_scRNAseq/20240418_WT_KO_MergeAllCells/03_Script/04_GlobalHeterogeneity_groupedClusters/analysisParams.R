...
ANALYSIS_STEP_NAME = "04_GlobalHeterogeneity_groupedClusters"
...
CELLS_COORDINATES = file.path( PATH_EXPERIMENT_OUTPUT,
                               "02_GlobalHeterogeneity_reClustering",
                               "ClusteringRes_1",
                               "Extra",
                               "002_IFNL_Recovery_scRNAseq_20240418_WT_KO_MergeAllCells_cellsCoordinates_umap.tsv")
...
# Must be TRUE if reloading from raw data.
...
GENES_BOSTON = as.list( read.table( file.path( PATH_EXPERIMENT_REFERENCE,
                                               "03_MonitoredGenes",
                                               "20240425_BostonTop10.csv"),
                                    sep = ",",
                                    header = TRUE,
                                    stringsAsFactors = FALSE,
                                    row.names = NULL, 
...
names( GENES_BOSTON) = paste0( "Boston10_", names(GENES_BOSTON)) 

MONITORED_GENES = c( GENES_SIBible_Consensus, GENES_SIBible_3Prime, GENES_SIBible_FullLength, GENES_AB, GENES_HALLMARK_IFNA, GENES_LUETAL, GENES_BOSTON)
