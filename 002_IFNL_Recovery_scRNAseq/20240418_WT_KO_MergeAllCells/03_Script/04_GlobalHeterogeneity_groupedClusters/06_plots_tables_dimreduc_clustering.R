...
cellsData = cbind( "Cell" = colnames( sc10x), # cell names from rownames conflict with search field in datatable
                    ...
                    "Sample" = sc10x[["factorHTO", drop = TRUE]],
                    "Condition" = sc10x[["orig.ident", drop = TRUE]],
                    cellsCoordinates,
...
# ..............................................................................
## @knitr plotClustersSizeBySample
# ..............................................................................
print( knitr::kable( addmargins(clustersCountBySample),
                    align   = "c",
                    caption = "Number of cells by population (Cluster) and sample")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);

# Get a table of proportion (for selected margin)
#print( knitr::kable( addmargins( prop.table( clustersCountBySample, margin = 1) * 100,
#                                 margin = 2),
#                     align   = "c",
#                     caption = "Proportion (pct) of cells in samples for each population (Cluster)")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);




# ..............................................................................
## @knitr plotClustersSizeByCondition
# ..............................................................................
print( knitr::kable( addmargins(clustersCountByCondition),
                     align   = "c",
                     caption = "Number of cells by population (Cluster) and condition")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);

# Get a table of proportion (for selected margin)
#print( knitr::kable( addmargins( prop.table( clustersCountByCondition, margin = 1) * 100,
#                                 margin = 2),
#                     align   = "c",
#                     caption = "Proportion (pct) of cells in conditions for each population (Cluster)")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);
...
# ..............................................................................
## @knitr plotCategoricalClusterHistogram
# ..............................................................................
...
{
  cat(paste0("\nCategorical distribution: '", currentCategoryName, "'\n\n"));
  ...
  saveWidget( widget = ggplotly( categoryPlot),
              file = file.path( PATH_ANALYSIS_OUTPUT, paste0( "clusteringBarplot_byCategory_", currentCategoryName, ".html")))
...
# ..............................................................................
## @knitr chisquare_test_clusters_condition
...
# ..............................................................................
chisq = chisq.test(clustersCountByCondition)
...
# ..............................................................................
## @knitr chisquare_test_clusters_condition_plotResidualsAndContributions
# ..............................................................................
...
# ..............................................................................
## @knitr chisquare_test_clusters_condition_plotMosaic
# ..............................................................................
mosaicplot( clustersCountByCondition, 
            shade = TRUE, 
            las = 2, 
            main = "X² residuals", 
            xlab="", 
...
# ..............................................................................
## @knitr plotDimReducInteractive_colorCondition
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# ..............................................................................
...
cat( paste0( '\n', 
             ...
             # Create a selector, each option corresponding to a plotly trace (defined here by color)
             '<select id="colorChange_traceSelector_plotly', figID, '" style="width: 200px;">', 
             paste('<option value="', c( 'undefined', 0:(nlevels( cellsData[["Condition"]])-1)), '">', c('All', levels( cellsData[["Condition"]])), '</option>', sep ="", collapse = " " ), 
             '</select>', 
             '&nbsp;&nbsp;',
             # Create HTML anchor for color picker
             '<input type="text" id="colorChange_colorPicker_plotly', figID, '" />', 
...
# ..............................................................................
## @knitr plotDimReducRaster_colorCondition
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# ..............................................................................
...
# ..............................................................................
## @knitr plotDimReducInteractive_colorClusters_symbolVarName
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# Can define 'symbolVarName' to an existing name in cellsData (default 'Sample')
# ..............................................................................
...
plotDimReduc = plot_ly( dataShare, # 'SharedData' object for plots interactions
                        ...
                        color = ~Cluster,
                        colors = clustersColor,
                        symbol = as.formula( paste0( "~", if(exists( "symbolVarName")) symbolVarName else "Sample" )),
                        width = dimReducWidth,
                        height = dimReducHeight) %>%
  add_trace( type = "scattergl",
             mode = "markers",
...
# ..............................................................................
## @knitr plotDimReducRaster_colorClusters_symbolVarName
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# Can define 'symbolVarName' to an existing name in cellsData (default 'Sample')
# ..............................................................................
...
ggFigure = ggplot(  cellsData, 
                    aes_string( x = colnames( cellsCoordinates)[1], 
                                y = colnames( cellsCoordinates)[2],
                                color = "Cluster",
                                pch = if(exists( "symbolVarName")) symbolVarName else "Sample" )) +
  geom_point( alpha = PLOT_DIMREDUC_GROUPS_ALPHA, 
              size  = PLOT_DIMREDUC_GROUPS_POINTSIZE)
...
# ..............................................................................
## @knitr plotDimReducInteractiveGG_colorVarName_facetVarName
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# Can define 'colorVarName' and 'facetVarName' to existing names in cellsData 
# (default 'Cluster' and 'Sample')
# ..............................................................................
...
ggFigure = ggplot(  cellsData, 
                    aes_string( x = colnames( cellsCoordinates)[1], 
                                y = colnames( cellsCoordinates)[2],
                                color = if(exists( "colorVarName")) colorVarName else "Cluster" )) +
  geom_point( stroke = 0) + # Just ignore point size and alpha here as it will be overriden after plotly conversion
  facet_wrap(facets = as.formula(paste0("~", if(exists( "facetVarName")) (facetVarName) else "Sample")))
...
ggFigure = ggFigure +
  scale_color_manual( name = colorVarName, values = clustersColor) +
  theme_classic() +
  theme( #axis.text  = element_blank(),
    axis.title = element_blank(),
    #axis.ticks  = element_blank(),
...
# ..............................................................................
## @knitr plotDimReducRaster_colorVarName_facetVarName
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# Can define 'colorVarName' and 'facetVarName' to existing names in cellsData 
# (default 'Cluster' and 'Sample')
# ..............................................................................
...
ggFigure = ggplot(  cellsData, 
                    aes_string( x = colnames( cellsCoordinates)[1], 
                                y = colnames( cellsCoordinates)[2],
                                if(exists( "colorVarName")) colorVarName else "Cluster" )) +
  geom_point( alpha = PLOT_DIMREDUC_GROUPS_ALPHA, 
              size  = PLOT_DIMREDUC_GROUPS_POINTSIZE) +
  facet_wrap(facets = as.formula(paste0("~", if(exists( "facetVarName")) (facetVarName) else "Sample")))
...
# ..............................................................................
## @knitr plotDimReducRaster_colorSample_facetClusters_allInBackground
# Can set logical for 'showDimReducClusterLabels' and 'showLegend' variables
# ..............................................................................

# Prepare dimreduc figure as ggplot
ggFigure = ggplot(  cellsData[c(colnames( cellsCoordinates)[1], colnames( cellsCoordinates)[2], "Sample")], # Omit the column used for facetting to get all points repeated in all facets
                    aes_string( x = colnames( cellsCoordinates)[1], 
                                y = colnames( cellsCoordinates)[2])) +
  geom_point( alpha = PLOT_DIMREDUC_GROUPS_ALPHA, 
...
cellsData_subset = cellsData[,c(colnames( cellsCoordinates), "Cluster", "Condition")]
...
# ..............................................................................
## @knitr plotDimReducRaster_colorDensity_circleDensity_facetByCondition
...
# ..............................................................................
## @knitr plotDimReducRaster_colorDensity_circleDensity_facetByConditionAndCluster
...
ggFigure = ggplot(  cellsData_subset, 
  ...
  facet_grid2( rows = vars( Condition), #vars( ifelse( grepl( "Panth", HTO), "Panth", "PBS")),
               cols = vars( Cluster),
               scales = "free",
               space = "fixed",
