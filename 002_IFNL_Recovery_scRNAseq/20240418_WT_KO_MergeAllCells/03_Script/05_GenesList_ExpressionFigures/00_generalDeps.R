...
violinFeatureByCluster = function(currentFeature, seuratObject, slot = "counts", clustersColor = NULL, yLabel = "Counts", addStats = TRUE, addTitle = TRUE, trimTitle = FALSE) 
{
  ...
  ggFigure = ggplot( data.frame( Counts = featureValues, Cluster = Idents( seuratObject)), 
    ...
    geom_jitter( width = 0.25, height = 0.05, size = 0.4, colour = "#44444444") +
...
violinFeatureByMetadata = function(currentFeature, seuratObject, slot = "counts", metadataName = "factorHTO", metadataColor = NULL, yLabel = "Counts", addStats = TRUE, addTitle = TRUE, trimTitle = FALSE, byCluster = TRUE) 
{
  ...
  # Plot expression values of current annotation for each cluster as violin + jitter
  ggFigure = ggplot( data.frame( Counts = featureValues, Cluster = factor( as.character(Idents( seuratObject))), meta = seuratObject[[metadataName, drop = TRUE]]), 
                     aes( x = meta, y = Counts)) +
    geom_jitter( width = 0.25, height = 0.05, size = 0.4, colour = "#44444444") +
