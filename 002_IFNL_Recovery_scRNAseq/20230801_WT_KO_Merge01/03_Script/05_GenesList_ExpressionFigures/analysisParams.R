...
PATH_RDS_SEURAT_OBJECT = file.path( PATH_EXPERIMENT_OUTPUT, 
                                    ...
                                    "002_IFNL_Recovery_scRNAseq_20230801_WT_KO_Merge01_seuratObject_final.RDS");
...
HEATMAPS_CLUSTERS_ORDERING = c( "CyclingCBC(stem)", "Enterocytes", "Enteroendocrine", "Goblet", "Paneth", "Revival Stem", "TransientAmpliProgenitor", "Tuft")
