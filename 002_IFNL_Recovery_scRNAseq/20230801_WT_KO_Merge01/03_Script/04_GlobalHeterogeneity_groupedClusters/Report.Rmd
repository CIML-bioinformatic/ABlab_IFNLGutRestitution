...
#### Interactive
```{r rmd_plotDimReducInteractive_colorCondition}
dimReducWidth  = 950;
dimReducHeight = 800;
initialPointSize = 5;
showDimReducClusterLabels = FALSE;
showLegend = TRUE;
<<plotDimReducInteractive_colorCondition>>
rm(showDimReducClusterLabels);
rm(showLegend);
```
<br />  
...
#### Raster
```{r rmd_plotDimReducRaster_colorCondition, fig.dim = c(11, 9)}
showDimReducClusterLabels = FALSE;
showLegend = TRUE;
<<plotDimReducRaster_colorCondition>>
rm(showDimReducClusterLabels);
rm(showLegend);
```
<br />  
